    ...
    <div style={{ minHeight: '100vh', background: 'var(--cream)' }}>
      ...
      <main style={{ maxWidth: 720, margin: '0 auto', padding: '48px 32px' }} className="page-enter">
        ...
        <div style={{ marginBottom: 36 }}>
          ...
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 32, fontWeight: 300, color: 'var(--ink)', lineHeight: 1.25, marginBottom: 10 }}>
            {profile.borough} · {profile.timeAway} away
          </h1>
          <p style={{ fontSize: 15, color: 'var(--ink-soft)', lineHeight: 1.65 }}>
            Here's your step-by-step plan. ID & Documents comes first — everything else depends on it.
          </p>
        </div>
        ...
        <div style={{
          ...
          padding: '22px 26px', marginBottom: 32, color: 'white',
                    ...
                    return (
                      <div key={step.id} style={{
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{ fontSize: 12, color: 'var(--green-mid)', marginBottom: 6 }}>⏱ {step.time}</div>
                          <div style={{
