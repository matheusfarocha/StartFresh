...
export const RESOURCES: Resource[] = [
  ...
  },
  {
    ...
    website: 'https://www.ssa.gov/number-card/replace-card',
    boroughs: ['All'],
    tags: ['free', 'walk-in'],
    source: 'SSA.gov',
  },
  {
    ...
    website: 'https://doccs.ny.gov/reentry-services',
    boroughs: ['All'],
    tags: ['free'],
    source: 'NYS DOCCS',
  },
  ...
  },
  {
    ...
    website: 'https://www.nyc.gov/site/hra/help/cityfheps.page',
    boroughs: ['All'],
    tags: ['free'],
  ...
  },
  {
    ...
    website: 'https://www.nyc.gov/site/cchr/law/fair-chance-act.page',
    boroughs: ['All'],
    tags: ['free'],
  ...
  },
  {
    ...
    categories: ['legal'],
    description:
      'New York law automatically sealing eligible conviction records after waiting period (3 years for misdemeanors, 8 years for most felonies). Contact Legal Aid Society to check your eligibility and get free help with the process.',
    phone: '(212) 577-3300',
  ...
  // ── Education ─────────────────────────────────────────────────
  {
    ...
    website: 'https://www.cuny.edu/admissions/undergraduate/',
    boroughs: ['All'],
    tags: ['free'],
    source: 'CUNY / NYC.gov',
  },
  {
    ...
    website: 'https://www.nycgov.org/ged',
    boroughs: ['All'],
    tags: ['free', 'walk-in'],
  ...
  },
  {
    ...
    website: 'https://www.nyc.gov/site/criminaljustice/index.page',
    boroughs: ['All'],
    tags: ['free'],
  ...
  // ── Additional Food ───────────────────────────────────────────
  {
    ...
    categories: ['food'],
    description:
      'NYC\'s largest hunger-relief network connecting people to 1,200+ emergency food providers — soup kitchens, pantries, shelters, and senior centers across all five boroughs. No ID required.',
    phone: '(212) 566-7855',
    address: '39 Broadway, New York, NY 10006',
    website: 'https://www.foodbanknyc.org',
    boroughs: ['All'],
    tags: ['free', 'no-id-required'],
    source: 'Food Bank For NYC',
  },
  {
    id: 'ny-common-pantry',
    ...
    categories: ['food'],
    description:
      'Free food distribution, case management, and support for unhoused individuals in East Harlem. Walk-in friendly, no ID required.',
    phone: '(917) 720-9700',
  ...
  },
  {
    ...
    categories: ['food'],
    description:
      'Choice-model food pantry where clients select their own groceries with dignity. Two Manhattan locations, no ID required.',
    phone: '(212) 362-3662',
  ...
  },
  {
    ...
    description:
      'Free breakfast, lunch, and dinner served 365 days a year with no ID required. NYC\'s oldest meal program — also provides shelter, clothing, and transitional support.',
  ...
  {
    id: 'justice-opportunity',
    name: 'Institute for Justice and Opportunity (John Jay / CUNY)',
    categories: ['education', 'community'],
    description:
      'College pathways, GED prep, tech training, and career development specifically for people with conviction histories. Includes the Prison-to-College Pathways program.',
    address: '524 W 59th St, Suite 609B, New York, NY 10019',
    website: 'https://justiceandopportunity.org',
    boroughs: ['All'],
    tags: ['free'],
    source: 'John Jay College / CUNY',
  },
  {
    id: 'college-community-fellowship',
    name: 'College & Community Fellowship',
    categories: ['education'],
    description:
      'Supports women with criminal convictions in earning college degrees through academic counseling, financial assistance, scholarships, and career advancement.',
    phone: '(646) 380-7770',
    address: '475 Riverside Drive, Suite 1626, New York, NY 10115',
    website: 'https://www.collegeandcommunity.org',
    boroughs: ['All'],
    tags: ['free', 'women-only'],
    source: 'College & Community Fellowship',
  },
  {
    id: 'goso',
    name: 'GOSO — Getting Out and Staying Out',
    categories: ['education', 'employment', 'community'],
    description:
      'Education, GED support, job training, counseling, and mentoring for justice-involved young people ages 16–24. Less than 7% of participants return to jail.',
    phone: '(212) 831-5020',
    address: '91 E 116th St, New York, NY 10029',
    hours: 'Mon–Fri 9am–5pm',
    website: 'https://www.gosonyc.org',
    boroughs: ['Manhattan'],
    tags: ['free'],
    source: 'GOSO / NYC DCJS partner',
  },
  {
    id: 'renaissance-technical',
    name: 'Renaissance Technical Institute',
    categories: ['education', 'employment'],
    description:
      'Free vocational training in HVAC, plumbing, carpentry, electrical, and IT for adults 17+. Explicitly welcomes people with criminal records and those without a high school diploma.',
    phone: '(212) 722-5000',
    address: '173 E 112th St, New York, NY 10029',
    website: 'https://renaissancetechnicalinstitute.org',
    boroughs: ['Manhattan'],
    tags: ['free'],
    source: 'Renaissance Technical Institute',
  },

  // ── Additional ID & Documents ─────────────────────────────────
  {
    id: 'brooklyn-da-reentry',
    name: 'Kings County Reentry Task Force (Brooklyn DA)',
    categories: ['id', 'legal'],
    description:
      'Case management, document recovery assistance, benefits enrollment, and referrals for people returning to Brooklyn from state prison.',
    phone: '(718) 250-3281',
    address: '345 Adams St, 7th Floor, Brooklyn, NY 11201',
    website: 'https://www.brooklynda.org/reentry/',
    boroughs: ['Brooklyn'],
    tags: ['free'],
  ...
  {
    id: 'exodus-transitional',
    name: 'Exodus Transitional Community',
    categories: ['community', 'employment', 'mentalHealth'],
    description:
      'Peer-led reentry organization offering credible messenger mentoring, workforce development, mental health clinic, and programs for women. Run largely by formerly incarcerated staff.',
    phone: '(917) 492-0990',
    ...
    boroughs: ['Manhattan'],
    tags: ['free'],
    source: 'Exodus Transitional Community',
  },

  // ── Additional Family ─────────────────────────────────────────
  {
    id: 'afj',
    name: 'Alliance of Families for Justice',
    categories: ['family', 'community'],
    description:
      'Supports and mobilizes families of incarcerated people through a family support unit, youth empowerment programs, and advocacy for criminal justice reform.',
    phone: '(347) 973-0580',
    address: '8 W 126th St, 3rd Floor, New York, NY 10027',
    website: 'https://afj-ny.org',
    boroughs: ['All'],
    tags: ['free'],
    source: 'Alliance of Families for Justice',
  },

  // ── Additional ID & Documents ─────────────────────────────────
  {
    id: 'catholic-charities-docs',
    name: 'Catholic Charities — Document & Benefits Help',
    categories: ['id'],
    description:
      'Case management including help with ID recovery, benefits enrollment, and vital document assistance for low-income New Yorkers. Serves all boroughs.',
    phone: '(888) 744-7900',
    address: '1011 First Avenue, New York, NY 10022',
    website: 'https://catholiccharitiesny.org',
    boroughs: ['All'],
    tags: ['free'],
    source: 'Catholic Charities NY',
  },
  ...
  // ── Additional Family ─────────────────────────────────────────
  {
    ...
    categories: ['family', 'housing', 'community'],
    description:
      'Family reunification support, parenting programs, housing, and case management for justice-involved women in NYC. Over 175 years of service.',
    phone: '(646) 292-7740',
    address: '110 Second Avenue, New York, NY 10003',
    website: 'https://www.wpaonline.org',
    boroughs: ['All'],
    tags: ['free', 'women-only'],
  ...
  },
  {
    ...
    categories: ['family', 'legal'],
    description:
      'Family-focused reentry services including advocacy around child custody and family court matters for people with criminal records.',
    phone: '(212) 979-6500',
    address: '25 Chapel St, Suite 703, Brooklyn, NY 11201',
    website: 'https://www.communityalternatives.org',
    boroughs: ['Brooklyn', 'Manhattan'],
    tags: ['free'],
  ...
  // ── Additional Housing ────────────────────────────────────────
  {
    ...
    description:
      'Transitional housing with immediate paid work for homeless and formerly incarcerated men. Includes job training, career placement, and long-term support.',
    phone: '(212) 628-5207',
    address: '232 East 84th St, New York, NY 10028',
  ...
  },
  {
    ...
    categories: ['housing'],
    description:
      'Supportive and transitional housing programs across NYC specifically serving people exiting incarceration and homelessness. Case management included.',
    phone: '(212) 496-6700',
  ...
  // ── Additional Food ───────────────────────────────────────────
  {
    ...
    categories: ['food'],
    description:
      'Daily dining room, food pantry, and nutrition programs serving low-income Bronx residents. No eligibility restrictions, walk in anytime.',
    phone: '(718) 220-4892',
  ...
  },
  {
    ...
    categories: ['food'],
    description:
      'One of NYC\'s largest soup kitchens serving free hot meals Monday through Friday in Chelsea. No questions asked, no ID needed.',
    phone: '(212) 924-0167',
    ...
    boroughs: ['Manhattan'],
    tags: ['free', 'walk-in', 'no-id-required'],
    source: 'Holy Apostles',
  },

  // ── Additional Legal ──────────────────────────────────────────
  {
    id: 'brooklyn-defender-services',
    name: 'Brooklyn Defender Services — Reentry',
    categories: ['legal'],
    description:
      'Dedicated reentry legal assistance including certificate of relief, record sealing, and removing legal barriers for formerly incarcerated Brooklyn residents.',
    phone: '(718) 254-0700',
    address: '177 Livingston St, 7th Floor, Brooklyn, NY 11201',
    website: 'https://bds.org',
    boroughs: ['Brooklyn'],
    tags: ['free'],
