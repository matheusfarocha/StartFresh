        ...
        <div className="flex items-center gap-3 bg-surface-container rounded-xl px-4 py-3 mb-4 focus-within:ring-2 focus-within:ring-primary/30 transition-all">
          ...
          {isLoggedIn && (
            <button
              ...
              className="flex items-center gap-2 bg-primary text-on-primary px-4 py-2 rounded-full font-headline font-bold text-sm shadow-[0_3px_0_0_#612f00] active:translate-y-1 active:shadow-none transition-all cursor-pointer shrink-0"
            >
